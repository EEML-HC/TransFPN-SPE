...
load_from  = 'work_dirs/voc_fin_split3_10shots_cocotrain/latest.pth'
...
classes =  ('aeroplane', 'bicycle', 'bird', 'bottle', 'bus',
           ...
           'person', 'pottedplant', 'train', 'tvmonitor', 'Arrester', 'Circuit-breaker', 'Current transformer',
           'Voltage transformer', 'Isolating switch')
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=1,
    train=dict(
...
runner = dict(type='EpochBasedRunnerAmp', max_epochs=58)
