...
load_from  = 'work_dirs/imted_faster_rcnn_vit_base_2x_finetuning_10shot_coco/latest.pth'
...
data = dict(
    ...
    train=dict(
        ...
        classes = classes, 
        ann_file='data/CDFSOD/UODD/annotations/10_shot.json',
	img_prefix='data/CDFSOD/UODD/train/'),
    val=dict(
        classes = classes, 
        ann_file='data/CDFSOD/UODD/annotations/test.json',
	img_prefix='data/CDFSOD/UODD/test/'),
    test=dict(
        classes = classes, 
        ann_file='data/CDFSOD/UODD/annotations/test.json',
	img_prefix='data/CDFSOD/UODD/test/'))
