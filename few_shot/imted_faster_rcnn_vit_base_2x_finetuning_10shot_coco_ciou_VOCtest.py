...
load_from  = 'work_dirs/imted_faster_rcnn_vit_base_2x_base_training_coco_ciou/latest.pth'
...
classes_test =  ('aeroplane', 'bicycle', 'bird', 'bottle', 'bus',
           'car', 'chair', 'cow', 'diningtable', 'dog', 'horse',
           'person', 'pottedplant', 'train', 'tvmonitor', 'Arrester', 'Circuit-breaker', 'Current transformer', 'Voltage transformer', 'Isolating switch')
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        ...
        classes = classes, 
        ann_file='data/coco/annotations/datasets/cocosplit/full_box_10shot_trainval.json'),
    val=dict(
